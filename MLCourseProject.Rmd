...
```
We get the great accuracy of 99.55 which shows **out of sample error rate** is **0.5%**. The RandomForest is a good enough method and we don't need to test any other.
```{r}
plot(rfmodel)
```
